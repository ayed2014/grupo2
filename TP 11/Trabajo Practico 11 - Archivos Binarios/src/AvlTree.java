...
public class AvlTree {
     ...
     */
    public void insert(int k, long filePointer) {
        // create new node
        AvlNode n = new AvlNode(k, filePointer);
    ...
    public long findNode(int key) {
        return findNode(this.root, key);
    }

    public long findNode(AvlNode n, int key) {
        if (n == null) return -1;
        else {
            if (n.key > key)
                if (n.key > key) {
